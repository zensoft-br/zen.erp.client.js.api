...
export default class ControlMaterialIncomingRequest extends ControlSelectZen<any> {
  constructor() {
    super();
    this._order = "id";
  }
  ...
  protected getString(value: any): string | null {
    return value
      ? `${value.code == null ? value.id : value.code}, ${value.status}, ${value.date}, ${
