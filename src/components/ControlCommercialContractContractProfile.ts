...
export default class ControlCommercialContractContractProfile extends ControlSelectZen<any> {
  constructor() {
    super();
    this._order = "code";
  }
  ...
  protected getAsyncIteratorZen(args: ControlSelectZenArgs): AsyncIterator<any> {
    ...
    return new AsyncIteratorZen(
      `/commercial/contract/contractProfile${params.toString() ? `?${params.toString()}` : ""}`,
    );
  }
