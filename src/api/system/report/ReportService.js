export class ReportService {
  ...
  async reportOpProxy(id, reportIdDelegate) {
    return this.#zenClient.web.fetchJson(`/system/report/reportOpProxy/${id}?reportIdDelegate=${reportIdDelegate}`, {
      method: "POST",

    });
  }

  async reportOpProxyRevert(id) {
    return this.#zenClient.web.fetchJson(`/system/report/reportOpProxyRevert/${id}`, {
      method: "POST",
