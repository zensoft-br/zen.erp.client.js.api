export class SaleService {
  ...
  async priceFormationOpCalculate(id, value) {
    return this.#zenClient.web.fetchJson(`/sale/priceFormationOpCalculate?id=${id}&value=${value}`, {
      method: "POST",
  ...
  async priceFormationOpCalculateProductPacking(id, productPackingId, value) {
    return this.#zenClient.web.fetchJson(`/sale/priceFormationOpCalculateProductPacking?id=${id}&productPackingId=${productPackingId}&value=${value}`, {
      method: "POST",
