export class MaterialService {
  ...
  async inventoryAdjustmentOpCreate(id, stockId, quantity) {
    return this.#zenClient.web.fetchJson(`/material/inventoryAdjustmentOpCreate/${id}?stockId=${stockId}&quantity=${quantity}`, {
      method: "POST",
  ...
  async inventoryStockOpCreate(id, stockId) {
    return this.#zenClient.web.fetchJson(`/material/inventoryStockOpCreate/${id}?stockId=${stockId}`, {
      method: "POST",
  ...
  async pickingOrderOpDistribute(id, outgoingListId, stockId, quantity) {
    return this.#zenClient.web.fetchJson(`/material/pickingOrderOpDistribute/${id}?outgoingRequestItemId=${outgoingRequestItemId}&stockId=${stockId}&quantity=${quantity}`, {
      method: "POST",
  ...
  async reservationOpAllocateStock(id, stockId, quantity) {
    return this.#zenClient.web.fetchJson(`/material/reservationOpAllocateStock/${id}?stockId=${stockId}&quantity=${quantity}`, {
      method: "POST",
  ...
  async reservationOpAllocateStockRevert(id, stockId, quantity) {
    return this.#zenClient.web.fetchJson(`/material/reservationOpAllocateStockRevert/${id}?stockId=${stockId}&quantity=${quantity}`, {
      method: "POST",
  ...
  async stockPointRead(dateTime, search) {
    return this.#zenClient.web.fetchJson(`/material/stockPoint?${search}?dateTime=${dateTime}`, {
      method: "GET",
