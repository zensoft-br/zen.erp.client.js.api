export class BillingService {
	...
	async instructionRequestOpAddToBatch(id, batchId) {
		return this.#zenClient.web.fetchJson(`/financial/billing/instructionRequestOpAddToBatch/${id}?batchId=${batchId}`, {
			method: "POST",
	...
	async instructionRequestOpCreateChangeDueDate(billingTitleId, dueDate) {
		return this.#zenClient.web.fetchJson(`/financial/billing/instructionRequestOpCreateChangeDueDate?billingTitleId=${billingTitleId}&dueDate=${dueDate}`, {
			method: "POST",
	...
	async instructionRequestOpCreateRegister(billingTitleId, walletId) {
		return this.#zenClient.web.fetchJson(`/financial/billing/instructionRequestOpCreateRegister?billingTitleId=${billingTitleId}&walletId=${walletId}`, {
			method: "POST",
	...
	async instructionRequestOpCreateUnregister(billingTitleId) {
		return this.#zenClient.web.fetchJson(`/financial/billing/instructionRequestOpCreateUnregister?billingTitleId=${billingTitleId}`, {
			method: "POST",
