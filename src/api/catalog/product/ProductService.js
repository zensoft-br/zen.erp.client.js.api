export class ProductService {
  ...
  async productOpConvertToUnit(id, unitId, quantity) {
    return this.#zenClient.web.fetchJson(`/catalog/product/productOpConvertToUnit/${id}?unitId=${unitId}&quantity=${quantity}`, {
      method: "POST",
  ...
  async productPackingOpConvertToUnit(id, unitId, quantity) {
    return this.#zenClient.web.fetchJson(`/catalog/product/productPackingOpConvertToUnit/${id}?unitId=${unitId}&quantity=${quantity}`, {
      method: "POST",
