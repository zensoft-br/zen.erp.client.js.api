export class ContractService {
  ...
  async contractBillingOpCreate(contractId) {
    return this.#zenClient.web.fetchJson(`/service/contract/contractBillingOpCreate?contractId=${contractId}`, {
      method: "POST",
  ...
  async contractBillingOpCreateRevert(contractId) {
    return this.#zenClient.web.fetchJson(`/service/contract/contractBillingOpCreateRevert?contractId=${contractId}`, {
      method: "POST",
