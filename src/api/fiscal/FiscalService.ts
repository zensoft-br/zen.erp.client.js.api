export class FiscalService {
	...
	async fiscalYearOpPartialClosure(id, date) {
		this.#zenClient.web.fetchJson(`/fiscal/fiscalYearOpPartialClosure/${id}?date=${date}`, {
			method: "POST",
	...
	async fiscalYearOpPartialClosureRevert(id, date) {
		this.#zenClient.web.fetchJson(`/fiscal/fiscalYearOpPartialClosureRevert/${id}?date=${date}`, {
			method: "POST",
