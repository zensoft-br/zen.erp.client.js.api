export class FiscalBrService {
  ...
  async dfeNfeProcOutOpCreate(invoiceId) {
    ...
    return this.#zenClient.web.fetchJson(`/fiscal/br/dfeNfeProcOutOpCreate?${sp.toString()}`, {
      method: "POST",
  ...
  async dfeResNFeInOpManifest(id, status) {
    ...
    this.#zenClient.web.fetchJson(`/fiscal/br/dfeResNFeInOpManifest/${id}?${sp.toString()}`, {
      method: "POST",
